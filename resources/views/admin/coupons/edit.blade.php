                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span id="discountSymbol" class="text-gray-500 sm:text-sm">{{ $coupon->type == 'fixed' ? '$' : '%' }}</span>
                                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="excluded_product_ids[]" multiple
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" {{ in_array($product->id, old('excluded_product_ids', [])) ? 'selected' : '' }}>
                                        {{ $product->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <dd class="mt-1 text-2xl font-bold text-gray-900">{{ $coupon->used_count }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Total Savings</dt>
                            <dd class="mt-1 text-2xl font-bold text-gray-900">${{ number_format($coupon->used_count * $coupon->value, 2) }}</dd>
                        </div>
                        <div>
