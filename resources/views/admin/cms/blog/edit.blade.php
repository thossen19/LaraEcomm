...
<div class="max-w-7xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6 lg:p-8">
            <form action="{{ route('admin.cms.blog.update', $post) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" id="excerpt" rows="3" maxlength="500"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('excerpt', $post->excerpt) }}</textarea>
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div>
                        ...
                        <label for="featured_image" class="block text-sm font-medium text-gray-700">Upload New Image</label>
