...
<div class="max-w-7xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6 lg:p-8">
            <form action="{{ route('admin.cms.banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="position" id="position" required
                                ...
                                <option value="main_banner" {{ old('position') == 'main_banner' ? 'selected' : '' }}>Main Banner</option>
                                <option value="side_banner_1" {{ old('position') == 'side_banner_1' ? 'selected' : '' }}>Side Banners1</option>
                                <option value="side_banner_2" {{ old('position') == 'side_banner_2' ? 'selected' : '' }}>Side Banners2</option>
